...
object style:
  ...
  /**
   * We prefer the Python-like Scala 3 code style,
  ...
  object scala3StyleObject:
     ...
     *
     * This code simply prints `I like Scala 3 style`.
     * We do not use `print` or `println` for testing -
     * it is much better to use explicit tests.
     *
     * If, for some reason, you decide to use printing for local testing,
   ...
   *
   * Sometimes it is not possible to use only Scala 3 indentation-based syntax;
   * such cases will be explicitly explained.
   */
